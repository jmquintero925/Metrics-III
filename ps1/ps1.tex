...
The Montecarlo simulation cleans up some of the error induced by $U_i$ as our estimates are even closer to the true underlying value and the standard error is still the same. The convergence in probability of the estimated standard error to the theoretical is an application of both the Law of Large Numbers and the continuous mapping theorem. 
\begin{figure}[htb]
    \centering
...
\end{figure}
\textcolor{red}{If it gives me time I will derivate the numbers of the theoretical distribution }
\end{solution}
\FloatBarrier
