...
\begin{align*}
    ...
    &= \frac{1}{\beta_1^S+\beta_1^D} \left( \operatorname{Var}\left(U^D\right) - \operatorname{Cov}\left(U^S, U^D \right) \right) \\
...
\begin{table}[H]
    \centering
    \input{ps3/tables/q4_partH_tab1.tex}
\end{table}
...
\begin{table}[H]
    \centering
    \input{ps3/tables/q4_partH_tab2.tex}
\end{table}
